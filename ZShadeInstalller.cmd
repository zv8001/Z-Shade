...
echo.
echo.
echo If you do not have Nvidia display drivers goto "https://www.nvidia.com/en-us/geforce-now/download/" or open GeForceNOW-release.exe to install GeForce now
echo.
echo.
